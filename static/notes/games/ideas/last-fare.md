# Last Fare
### A thriller driving simulator about a rideshare driver completing his shift day after day.

## Game Mechanics
Every night, the player clocks in to work. Starting their shift at the wheel, they start at their house every night.
...
There is UI for the in game dialogue system. This system displays at the bottom of the screen and functions as a basic dialogue display.

### Game Loop
The main game loop starts with the player getting in their car to start their shift for the day. The player starts by accepting or rejecting rides to people on the app.

When the player accepts a ride on the app, they get the route to the customer mapped on their GPS.

The player then has control over the car, and can go to the customer's location. The player can take whatever route they want to in order to get to the customer.

Then there is dialogue between the player and the customer and the player must have conversations to ensure the customer's satisfaction and simultaneously get them to their destination in a timely fashion.

---

## Core Tension: The Rearview Mirror as Inspection Booth

The rearview mirror is the central tension mechanic—the equivalent of the document inspection desk in Papers, Please. Driving demands eyes on the road, but survival increasingly demands watching the passenger.
...
## The Phone as Competing Systems

The phone is the player's multi-document workspace—the thing that creates cognitive overload.
...
## Escalating Verification Mechanics

Each new complication is a new "document rule" to track:

### Profile Photo Mismatch
The person at pickup doesn't look like the app photo. Do you let them in? Maybe it's an outdated photo. Maybe it's someone using a stolen account.

### Destination Mismatch
They get in and immediately ask to go somewhere different than the app says.
...
### Contraband Mechanic
A passenger asks you to hold onto something or deliver something. You don't know what's in it. The money is good. This is the "EZIC" equivalent—a shadow faction pulling you into complicity one small favor at a time.
...
## Storyline & Twist Ideas (Brainstorm)

### Option 1: The Other Driver
...
### Option 3: The Recursive Shift
Subtle at first—a passenger looks familiar. A ride request to an address visited before, but the name is different. The city starts repeating. Same conversations, same routes, but with small mutations. A passenger who was alive last week is now a missing person on the news.

This works as psychological horror without supernatural explanation—chronic night shifts and sleep deprivation fracturing perception. Or something is genuinely wrong with the city. The ambiguity is the horror.

---

## The Final Ride

The game's title should pay off. Build toward a final ride that the entire game has been setting up.

Every faction, every decision, every item left behind, every route taken—it all converges on one passenger, one destination, one choice.

The best version: the player doesn't realize the final ride is the final ride until they're already in it. The passenger gets in and says something that recontextualizes the entire game. Who this person is and what happens depends on everything the player has done.

**The Last Fare is literal.**
